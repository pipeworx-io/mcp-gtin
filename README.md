...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/validate_gtin \
  -H 'Content-Type: application/json' \
  -d '{"code":"0036000291452"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/validate_gtin`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
